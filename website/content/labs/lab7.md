...
It's a good thing we have the tests to tell us this but, unfortunately, nothing is preventing us from deploying this broken app. In fact, go ahead and do this:

To deploy the broken code:
```
...
Make the tests fail again and push to GitHub (*don't* push to Heroku; remember this is now going to be handled automatically by Heroku). The CI tests should fail and, if you navigate to your URL, you'll see that the broken version has not been deployed.
